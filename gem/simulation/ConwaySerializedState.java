...
public class ConwaySerializedState implements ISerializedState {
	...
	public ConwaySerializedState(ConwayState state) {
		this.state = convertToSerializationString(state);  
	}
	...
	public static String convertToSerializationString(ConwayState state) {
	...
	public static ConwayState deserialize(String string) {
		...
		return new ConwayState(cellList);
	}
